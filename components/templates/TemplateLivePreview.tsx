/**
 * Template Live Preview (Gallery/Selector)
 *
 * Lazily renders a scaled preview of a resume template using centralized sample data.
 */
...
export function TemplateLivePreview({ templateId, className = '', ariaLabel }: TemplateLivePreviewProps): React.ReactElement {
  ...
  if (!ready) {
    return (
      <div
        ...
        aria-label={ariaLabel || 'Template preview placeholder'}
      >
