/**
 * Resume Version API Routes: List Versions
 *
 * GET /api/v1/resumes/:id/versions - List all versions for a resume
 */
...
import { getVersions } from '@/libs/repositories/versions'
...
export const GET = withAuth(
  async (req: NextRequest, user, { params }: { params: { id: string } }) => {
    try {
      ...
      console.error('GET /api/v1/resumes/:id/versions error:', error)
