/**
 * Cover Letter Version API Routes: Get Specific Version
 *
 * GET /api/v1/cover-letters/:id/versions/:versionNumber - Get specific version
 */
...
import { getVersion } from '@/libs/repositories/coverLetterVersions'
...
export const GET = withAuth(
  async (
    ...
    try {
      ...
      console.error('GET /api/v1/cover-letters/:id/versions/:versionNumber error:', error)
