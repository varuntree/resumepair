...
export const categories: categoryType[] = [
  {
    ...
    description:
      "Here are the latest features we've added to ResumePair. I'm constantly improving our product to help you build better resumes.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to ResumePair.",
  },
  {
    ...
    description:
      "Learn how to use ResumePair with these step-by-step tutorials. I'll show you how to build better resumes and cover letters.",
    descriptionShort:
      "Learn how to use ResumePair with these step-by-step tutorials.",
  },
];
...
export const articles: articleType[] = [
  {
    ...
    title: "Introducing Supabase to ResumePair",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a backend for your app. It's now integrated with ResumePair!",
    ...
    image: {
      ...
      alt: "Supabase and ResumePair logo combined",
    },
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
        ...
        <section>
          <h3 className={styles.h3}>2. Add your credentials to ResumePair</h3>
          <p className={styles.p}>
            Copy the <span className={styles.codeInline}>API URL</span> and{" "}
            <span className={styles.codeInline}>API Key</span> from your
            Supabase project settings and add them to your ResumePair project
